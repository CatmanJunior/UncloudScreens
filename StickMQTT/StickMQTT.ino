...
const byte FADERPIN1 = 5; // Connect your button to pin #13
const byte FADERPIN2 = 4; // Connect your button to pin #13
const byte FADERPIN3 = 13; // Connect your button to pin #13
const byte LEDPIN = 0;
